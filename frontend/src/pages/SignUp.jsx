...
function SecurityNote() {
  return (
    <div className="flex items-center gap-3 mt-5 p-3 bg-blue-50 rounded-xl border border-blue-100">
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-blue-100/50 border border-blue-50 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {form.password && (
                  <div className="mt-2">
                    <div className="flex gap-1 mb-1">
                      {[1, 2, 3, 4].map(i => (
                        <div key={i}
                          className={`flex-1 h-1 rounded-full transition-all duration-300 ${i <= strength.score ? strength.color : "bg-gray-100"}`} />
                      ))}
                    </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold text-sm py-3 rounded-xl flex items-center justify-center gap-2 transition-colors shadow-md shadow-blue-200 mt-1">
                {loading ? (
