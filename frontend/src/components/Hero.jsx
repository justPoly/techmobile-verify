...
export default function Hero() {
  ...
  const handleSearch = () => {
    ...
    // Navigate to LoadingState with the searched phone name
    navigate('/loading', { 
    ...
    <section className="w-full bg-white">
      <div className={`${container} py-10 md:py-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-center`}>
        ...
        <div className="order-2 md:order-1">
          ...
          {/* Search Bar - Now connected to loading */}
          <div className="flex items-center border-2 border-gray-200 rounded-xl overflow-hidden
            ...
            <button 
              ...
              className="bg-blue-600 hover:bg-blue-700 p-3 transition-colors flex-shrink-0"
            >
          ...
          <div className="flex flex-wrap items-center gap-2 mt-4">
            ...
            {popularSearches.map((s) => (
              <button 
                ...
                onClick={() => {
                  setSearchQuery(s);
                  navigate('/loading', { state: { phoneName: s } });
                }}
